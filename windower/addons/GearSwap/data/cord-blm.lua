...
function init_gear_sets()
    ...
    sets.precast.FC['Enhancing Magic'] = set_combine(sets.precast.FC, {waist="Siegel Sash", main="Kirin's Pole", body="Errant Houppelande"})
    ...
    sets.midcast.Cure = {main="Chatoyant Staff",
        ...
        body="Mahatma Houppelande",hands="Bokwus Gloves",ring1="Tamas Ring",ring2="Sirona's Ring",
        back="Prism Cape",waist="Penitent's Rope",legs="Mahatma Slops",feet="Rostrum Pumps"}
    ...
    sets.midcast['Enfeebling Magic'] = {main="Chatoyant Staff",
        head="Zenith Crown",neck="Colossus's Torque",ear1="Magnetic Earring",ear2="Loquacious Earring",
        body="Mahatma Houppelande",hands="Oracle's Gloves",ring1="Tamas Ring",ring2="Sirona's Ring",
        back="Prism Cape",waist="Sorcerer's Rope",legs="Mahatma Slops",feet="Avocat Pigaches"}
    ...
    sets.midcast['Dark Magic'] = {main="Chatoyant Staff",sub="Dark Grip",ammo="Sturm's Report",
        ...
        body="Mahatma Houppelande",hands="Sorcerer's Gloves",ring1="Tamas Ring",ring2="Insect Ring",
        back="Prism Cape",waist="Sorcerer's Belt",legs="Wizard's Tonban",feet="Rostrum Pumps"}

    sets.midcast.Drain = {main="Chatoyant Staff",sub="Dark Grip",ammo="Sturm's Report",
        head="Nahtirah Hat",neck="Dark Torque",ear1="Abyssal Earring",ear2="Loquacious Earring",
        body="Mahatma Houppelande",hands="Vicious Mufflers",ring1="Tamas Ring",ring2="Insect Ring",
        back="Prism Cape",waist="Sorcerer's Belt",legs="Wizard's Tonban",feet="Rostrum Pumps"}
    ...
    sets.midcast['Elemental Magic'] = {main="Chatoyant Staff",sub="Bugard Leather Strap",ammo="Phantom Tathlum",
        head="Sorcerer's Petasos +1",neck="Elemental Torque",ear1="Moldavite Earring",ear2="Loquacious Earring",
    ...
    sets.midcast['Elemental Magic'].Resistant = {main="Chatoyant Staff",sub="Bugard Leather Strap",ammo="Phantom Tathlum",
        head="Sorcerer's Petasos +1",neck="Elemental Torque",ear1="Moldavite Earring",ear2="Loquacious Earring",
        body="Oracle's Robe",hands="Wizard's Gloves",ring1="Tamas Ring",ring2="Snow Ring",
        back="Prism Cape",waist="Sorcerer's Belt",legs="Mahatma Slops",feet="Numerist Pumps"}
    ...
    sets.resting = {main="Chatoyant Staff",ammo="Clarus Stone",
        ...
        waist="Austerity Belt",legs="Oracle's Braconi",feet="Numerist Pumps"}
