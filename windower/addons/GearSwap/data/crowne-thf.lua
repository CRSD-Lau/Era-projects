...
function init_gear_sets()
	...
	sets.precast.Ninjutsu = {head="Walahra Turban",ear1="Suppanomimi",ear2="Loquacious Earring",
        ...
        waist="Velocious Belt",legs="Homam Cosciales",feet="Dusk Ledelsens"}
    ...
    sets.precast.WS = {head="Enkidu's Cap",neck="Peacock Amulet",
        body="Hecatomb Harness",hands="Hecatomb Mittens",ring1="Thunder Ring",ring2="Rajas Ring",
        back="Assassin's Cape",waist="Potent Belt",legs="Hecatomb Subligar",feet="Hecatomb Leggings"}

    sets.precast.WS.Acc = {head="Homam Zucchetto",neck="Soil Gorget",ear1="Ethereal Earring",ear2="Brutal Earring",
	...
	head="Enkidu's Cap",feet="Hecatomb Leggings",hands="Hecatomb Mittens"})
    --------------------------------------
    -- Midcast sets
    --------------------------------------
	...
	sets.engaged.Haste = {
        ...
        body="Rapparee Harness",hands="Assassin's Armlets +1",ring1="Toreador's Ring",ring2="Rajas Ring",
        back="Assassin's Cape",waist="Velocious Belt",legs="Bravo's Subligar",feet="Dusk Ledelsens"}
		
    sets.engaged.TH = {main = "Mandau",Sub = "Thief's Knife",range="Fire Bomblet",
        head="Walahra Turban",neck="Peacock Amulet",ear1="Suppanomimi",ear2="Brutal Earring",
    ...
    sets.idle = {head="Walahra Turban",neck="Peacock Amulet",ear1="Suppanomimi Earring",ear2="Brutal Earring",
        body="Scorpion Harness",hands="Assassin's Armlets +1",ring1="Breeze Ring",ring2="Rajas Ring",
