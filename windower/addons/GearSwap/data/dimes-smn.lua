...
function init_gear_sets()
    ...
    sets.precast.JA['Elemental Siphon'] = {hands="Summoner's Bracers +1",legs="Oracle's Braconi"}

    sets.precast.JA['Mana Cede'] = {hands="Caller's Bracers +2"}

    -- Pact delay reduction gear
    sets.precast.BloodPactWard = {head="Summoner's Horn +1",body="Yinyang Robe",hands="Summoner's Bracers +1",
        back="Samanisi Cape",feet="Summoner's Pigaches +1"}
    ...
    sets.midcast.Pet.BloodPactWard = {head="Summoner's Horn +1",body="Yinyang Robe",hands="Summoner's Bracers +1",
        back="Samanisi Cape",feet="Summoner's Pigaches +1"}

    sets.midcast.Pet.DebuffBloodPactWard = {head="Summoner's Horn +1",body="Yinyang Robe",hands="Summoner's Bracers +1",
        back="Samanisi Cape",feet="Summoner's Pigaches +1"}
        
    sets.midcast.Pet.DebuffBloodPactWard.Acc = sets.midcast.Pet.DebuffBloodPactWard
    
    sets.midcast.Pet.PhysicalBloodPactRage = {head="Summoner's Horn +1",body="Yinyang Robe",hands="Summoner's Bracers +1",
        back="Samanisi Cape",feet="Summoner's Pigaches +1"}

    sets.midcast.Pet.PhysicalBloodPactRage.Acc = sets.midcast.Pet.PhysicalBloodPactRage

    sets.midcast.Pet.MagicalBloodPactRage = {head="Summoner's Horn +1",body="Yinyang Robe",hands="Summoner's Bracers +1",
        back="Samanisi Cape",feet="Summoner's Pigaches +1"}
    ...
    -- Resting sets
    sets.resting = {main="Chatoyant Staff",ammo="Phantom Tathlum",
        head="Oracle's Cap",neck="Beak Necklace +1",ear1="Magnetic Earring",ear2="Loquacious Earring",
        body="Oracle's Robe",hands="Oracle's Gloves",ring1="Tamas Ring",ring2="Paguroidea Ring",
        back="Pahtli Cape",waist="Austerity Belt",legs="Oracle's Braconi",feet="Avocat Pigaches"}
    
    -- Idle sets
    sets.idle = {main="Chatoyant Staff",ammo="Phantom Tathlum",
        head="Summoner's Horn +1",neck="Morgana's Choker",ear1="Magnetic Earring",ear2="Loquacious Earring",
        body="Yinyang Robe",hands="Garden Bangles",ring1="Tamas Ring",ring2="Sangoma Ring",
        back="Prism Cape",waist="Headlong Belt",legs="Oracle's Braconi",feet="Herald's Gaiters"}
    ...
    sets.idle.Avatar = {main="Chatoyant Staff",sub="Bugard Leather Strap",ammo="Phantom Tathlum",
        neck="Morgana's Choker",ear1="Magnetic Earring",ear2="Loquacious Earring",
        hands="Summoner's Bracers +1",ring1="Tamas Ring",ring2="Evoker's Ring",
        back="Summoner's Cape",waist="Penitent's Rope",legs="Oracle's Braconi",feet="Summoner's Pigaches +1"}
    ...
    sets.idle.Spirit = {main="Chatoyant Staff",sub="Bugard Leather Strap",ammo="Phantom Tathlum",
        head="Summoner's Horn +1",neck="Ajari Bead Necklace",ear1="Magnetic Earring",ear2="Loquacious Earring",
        body="Yinyang Robe",hands="Summoner's Bracers +1",ring1="Tamas Ring",ring2="Evoker's Ring",
        back="Summoner's Cape",waist="Penitent's Rope",legs="Oracle's Braconi",feet="Summoner's Pigaches +1"}


    -- Favor uses Caller's Horn instead of Convoker's Horn for refresh
    sets.idle.Avatar.Favor = {head="Caller's Horn +2"}
    sets.idle.Avatar.Melee = {feet="Summoner's Pigaches +1"}
        
    sets.perp = {ring2="Evoker's Ring"}
    -- Caller's Bracer's halve the perp cost after other costs are accounted for.
    -- Using -10 (Gridavor, ring, Conv.feet), standard avatars would then cost 5, halved to 2.
    -- We can then use Hagondes Coat and end up with the same net MP cost, but significantly better defense.
    -- Weather is the same, but we can also use the latent on the pendant to negate the last point lost.
    sets.perp.Day = {body="Summoner's Doublet +1",ring2="Evoker's Ring"}
    sets.perp.Weather = {head="Summoner's Horn",ring2="Evoker's Ring"}
    -- Carby: Mitts+Conv.feet = 1/tick perp.  Everything else should be +refresh
    sets.perp.Carbuncle = {hands="Carbuncle Mitts",ring2="Evoker's Ring"}
    -- Diabolos's Rope doesn't gain us anything at this time
    --sets.perp.Diabolos = {waist="Diabolos's Rope"}
    sets.perp.Alexander = sets.midcast.Pet.BloodPactWard
	sets.perp.Garuda = {head="Karura Hachigane",ring2="Evoker's Ring"}
