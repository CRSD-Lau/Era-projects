function get_sets()                
    sets.precast = {}
    sets.precast.Charm = {main="Light Staff",neck="Beast Whistle",body="Custom Tunic"}
    ...
    sets.TP = {}
    sets.TP.DD = {main="Zoraal Ja's Axe",sub="Mahogany Shield",ammo="Potestas Bomblet",head="Uk'uxkaj Cap",neck="Fang Necklace",
